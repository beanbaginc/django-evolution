...
sys.path.insert(0, os.path.join(_tree_root, 'tests'))
...
htmlhelp_basename = 'DjangoEvolutiondoc'
...
latex_documents = [
    (master_doc, 'DjangoEvolution.tex', 'Django Evolution Documentation',
     'Beanbag, Inc.', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'DjangoEvolution', 'Django Evolution Documentation',
     author, 'DjangoEvolution', 'One line description of project.',
     'Miscellaneous'),
]
